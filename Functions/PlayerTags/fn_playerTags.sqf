    ...
    ULP_Draw3d_Tags = addMissionEventHandler["Draw3D", {
        {
            ...
            // Skip drawing the name tag for the player themselves
            if (_object isEqualTo player) exitWith {};
            ...
            [
                ...
                (_x getVariable ["icon", ""]), [_x, true] call ULP_fnc_getName, (_x getVariable ["subtitle", ""]), (_x getVariable ["title", ""] )
            ]
        });
    }];
};