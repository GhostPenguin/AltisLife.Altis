class CfgVehicles {
	...
	class C_Hatchback_01_F : Base {
		...
		class Textures {
			...
			class PoliceHWY : PoliceTexture {
				displayName = "Highway Patrol";
				conditions = "[""Police_RPU"", 1] call ULP_fnc_hasAccess";
				anpr = true;
				textures[] = { "Data\Textures\Vehicles\Land\Police\hatchback_HWY.paa" }; 
				class Lights : PoliceColour {
					leftPos[] = {0.458496,1.77002,-0.899953};
					rightPos[] = {-0.52002,1.75732,-0.94257};
				};
	...
	class C_SUV_01_F : Base {
		...
		class Textures {
			...
			class PoliceHWY : PoliceWhite { 
				displayName = "Highway Patrol";
				conditions = "[""Police_RPU"", 1] call ULP_fnc_hasAccess";
				anpr = true;
				textures[] = { "Data\Textures\Vehicles\Land\Police\hwp_suv.paa" };
				class Lights : PoliceColour {
					leftPos[] = {0.370605,2.22021,-0.531462};
					rightPos[] = {-0.396484,2.22119,-0.531462};
				}; 
