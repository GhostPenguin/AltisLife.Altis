...
class DialogTablet {
	...
	class Controls {
		...
		class Profile : ULP_RscButtonClean {
			...
			text = "<br/><br/><br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_singleplayer_ca.paa' align='center' size='7' background-color: black/><br/><t align = 'center'>Profile</t>";
		...
		class Inventory : ULP_RscButtonClean {
			idc = 23003;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='\a3\ui_f_curator\Data\RscCommon\RscAttributeInventory\filter_10_ca.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Inventory</t>";
		...
		class Messaging : ULP_RscButtonClean {
			idc = 23004;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='\a3\3den\data\Cfg3DEN\Comment\texture_ca.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Messaging</t>";
		...
		class Group : ULP_RscButtonClean {
			idc = 23005;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_multiplayer_ca.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Group</t>";
		...
		class Keys : ULP_RscButtonClean {
			idc = 23006;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='data\ui\keys.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Keys</t>";
		...
		class Dispute : ULP_RscButtonClean {
			idc = 23007;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='data\ui\dispute.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Dispute</t>";
		...
		class Market : ULP_RscButtonClean {
			idc = 23008;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='\a3\3den\data\Displays\Display3DEN\ToolBar\vert_ATL_ca.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Market</t>";
		...
		class Goals : ULP_RscButtonClean {
			idc = 23009;
			colorBackground[] = {0,0,0,1};
			text = "<br/><br/><img image='\a3\ui_f_curator\Data\CfgMPGameTypes\zsc_ca.paa' align='center' size='3' background-color: black/><br/><t align = 'center'>Community Goals</t>";
		...
		class Perks : ULP_RscButtonClean {
			idc = 23010;
			colorBackground[] = {0,0,0,1};
			text = "<br/><br/><img image='\a3\ui_f_curator\Data\RscCommon\RscAttributePunishmentAnimation\PushupsLegs.paa' align='center' size='3' background-color: black/><br/><t align = 'center'>Perks</t>";
		...
		class Settings : ULP_RscButtonClean {
			idc = 23011;
			colorBackground[] = {0,0,0,1};
			text = "<br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_options_ca.paa' align='center' size='4' background-color: black/><br/><t align = 'center'>Settings</t>";
